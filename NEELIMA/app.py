...
products = [
    ...
    {"id": 3, "name": "Chilli Pickle", "price": 130, "image": 'images/chilipickle.jpg'},
    {'id': 4, 'name': 'Chicken Pickle', 'price': 180, 'image': 'images/chickenpickle.jpg'},
...
def non_veg_pickles():
    pickles = [
        {'id': 3, 'name': 'Chicken Pickle', 'price': 180, 'image': 'images/chickenpickle.jpg'},
